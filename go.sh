...
export TRANSITCLOCK_PGPASSWORD=louth
export TRANSITCLOCK_DATABASE_USER=greenore
export TRANSITCLOCK_DOCKER_INSTANCE_NAME=transitclock-core-1
export TRANSITCLOCK_DATABASE_NAME=transitclock-database-1
export TRANSITCLOCK_WEB_PORT=8010
export TRANSITCLOCK_DATABASE_PORT=5410
export TRANSITCLOCK_QUEUE_NAME=transitclock-queue-1
export TRANSITCLOCK_GTFS_URL=https://transitfeeds.com/p/la-metro/184/latest/download
export TRANSITCLOCK_ACENCY_NAME=LAMETRO
