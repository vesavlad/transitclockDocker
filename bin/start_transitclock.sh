...
java -Xss12m -Xms3g -Xmx5g -XX:MaxDirectMemorySize=16G -Duser.timezone=PDT -Dlogback.configurationFile=/usr/local/transitclock/config/logback.xml -Dtransitclock.configFiles=/usr/local/transitclock/config/transitclock.properties -Dtransitclock.core.agencyId=$AGENCYID -Dtransitclock.logging.dir=/usr/local/transitclock/logs/ -jar /usr/local/transitclock/Core.jar > /usr/local/transitclock/logs/output.txt &
