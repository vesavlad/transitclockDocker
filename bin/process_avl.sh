...
wget https://github.com/scascketta/CapMetrics/blob/master/data/vehicle_positions/2017-11-13.csv -O /tmp/data.csv
...
wget https://github.com/scascketta/CapMetrics/blob/master/data/vehicle_positions/2017-11-14.csv -O /tmp/data.csv
...
wget https://github.com/scascketta/CapMetrics/blob/master/data/vehicle_positions/2017-11-15.csv -O /tmp/data.csv
...
wget https://github.com/scascketta/CapMetrics/blob/master/data/vehicle_positions/2017-11-16.csv -O /tmp/data.csv
...
wget https://github.com/scascketta/CapMetrics/blob/master/data/vehicle_positions/2017-11-17.csv -O /tmp/data.csv
java -Xmx2048m -Xss12m -Duser.timezone=EST -Dtransitime.configFiles=/usr/local/transitime/config/test/transiTimeConfig4.xml -Dtransitime.core.agencyId=$AGENCYID -Dtransitime.logging.dir=/usr/local/transitime/logs/ -jar $TRANSITIMECORE/transitime/target/Core.jar -configRev 0
java -Xmx2048m -Xss12m -Dnet.sf.ehcache.disabled=false -Duser.timezone=EST -Dtransitime.configFiles=/usr/local/transitime/config/test/transiTimeConfig4.xml -Dtransitime.core.agencyId=$AGENCYID -Dtransitime.logging.dir=/usr/local/transitime/logs/ -jar $TRANSITIMECORE/transitime/target/UpdateTravelTimes.jar 11-13-2017 11-17-2017

## RUN for another week without updates to travel times.
wget https://github.com/scascketta/CapMetrics/blob/master/data/vehicle_positions/2017-11-20.csv -O /tmp/data.csv
java -Xmx2048m -Xss12m -Duser.timezone=EST -Dtransitime.configFiles=/usr/local/transitime/config/test/transiTimeConfig4.xml -Dtransitime.core.agencyId=$AGENCYID -Dtransitime.logging.dir=/usr/local/transitime/logs/ -jar $TRANSITIMECORE/transitime/target/Core.jar -configRev 0

wget https://github.com/scascketta/CapMetrics/blob/master/data/vehicle_positions/2017-11-21.csv -O /tmp/data.csv
java -Xmx2048m -Xss12m -Duser.timezone=EST -Dtransitime.configFiles=/usr/local/transitime/config/test/transiTimeConfig4.xml -Dtransitime.core.agencyId=$AGENCYID -Dtransitime.logging.dir=/usr/local/transitime/logs/ -jar $TRANSITIMECORE/transitime/target/Core.jar -configRev 0


wget https://github.com/scascketta/CapMetrics/blob/master/data/vehicle_positions/2017-11-22.csv -O /tmp/data.csv
java -Xmx2048m -Xss12m -Duser.timezone=EST -Dtransitime.configFiles=/usr/local/transitime/config/test/transiTimeConfig4.xml -Dtransitime.core.agencyId=$AGENCYID -Dtransitime.logging.dir=/usr/local/transitime/logs/ -jar $TRANSITIMECORE/transitime/target/Core.jar -configRev 0


wget https://github.com/scascketta/CapMetrics/blob/master/data/vehicle_positions/2017-11-23.csv -O /tmp/data.csv
java -Xmx2048m -Xss12m -Duser.timezone=EST -Dtransitime.configFiles=/usr/local/transitime/config/test/transiTimeConfig4.xml -Dtransitime.core.agencyId=$AGENCYID -Dtransitime.logging.dir=/usr/local/transitime/logs/ -jar $TRANSITIMECORE/transitime/target/Core.jar -configRev 0

wget https://github.com/scascketta/CapMetrics/blob/master/data/vehicle_positions/2017-11-24.csv -O /tmp/data.csv
java -Xmx2048m -Xss12m -Duser.timezone=EST -Dtransitime.configFiles=/usr/local/transitime/config/test/transiTimeConfig4.xml -Dtransitime.core.agencyId=$AGENCYID -Dtransitime.logging.dir=/usr/local/transitime/logs/ -jar $TRANSITIMECORE/transitime/target/Core.jar -configRev 0
